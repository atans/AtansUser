...
" > /etc/apache2/sites-available/atansUser.conf
a2enmod rewrite
a2dissite 000-default
a2ensite atansUser
service apache2 restart
cd /var/www/atansUser
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.hostname = "atansUser.local"
  config.vm.synced_folder '.', '/var/www/atansUser'
